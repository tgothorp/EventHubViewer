...
function processJsonMessage(message)
{
    ...
    for (let i = 0; i < jsonValues.length; i++ ) {
        ...
        cell.innerText = <string>jsonValues[i];
    }
...
function generateSummary(messageContainer, message, messageFormat) {
    ...
    // Div to hold summary of message
    ...
    // Add button to un/collapse extra info
    ...
    collapseButton.addEventListener("click", function() {
        ...
        let content = <HTMLElement> this.nextElementSibling;
    ...
    // Add collapsed div to hold extra info
